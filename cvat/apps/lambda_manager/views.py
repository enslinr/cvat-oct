...
class LambdaFunction:
    ...
    def __init__(self, gateway, data):
        ...
        self.generate_without_prompting_optional = bool(meta_anno.get("generate_without_prompting_optional", False))
            ...
            response.update(
                {
                    ...
                    "generate_without_prompting_optional": self.generate_without_prompting_optional,
